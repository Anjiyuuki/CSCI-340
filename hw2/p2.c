...
#define DEBUG 1         // change to 0 when no longer debugging
...
Developing a http server that forks child processes, and uses signal
handlers to remove children from process table.
*/
